...
# Create a bot
bot = OnyxCord::Bot.new token: 'B0T.T0KEN.here'

# OnyxCord features an Awaits system that allows you to instantiate
...
# https://www.rubydoc.info/gems/onyxcord/OnyxCord%2FBot:add_await!
...
bot.message(content: '!time') do |event|
  ...
  bot.add_await!(OnyxCord::Events::ReactionAddEvent, message: message, emoji: CROSS_MARK, timeout: 30) do |_reaction_event|
...
# https://www.rubydoc.info/gems/onyxcord/OnyxCord/Await
# For a list of events you can use to await for, see:
# https://www.rubydoc.info/gems/onyxcord/OnyxCord/Events
